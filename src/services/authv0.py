...
# з цією конструкцією не стартує для рядків
# from src.repository import contacts as repository_contacts
# from src.repository import users as repository_users
# в директорії \src\repository - розібратись чому...

    # def __init__(self, schemes: list, deprecated: str, secret_key: str, algorithm: str, token_url: str):
